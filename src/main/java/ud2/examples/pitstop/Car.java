...
public class Car {
    ...
    public Car() {
        ...
        frontLeftTire = new Tire("delantero izquierdo");
        tires.add(frontLeftTire);
        frontRightTire = new Tire("delantero derecho");
        tires.add(frontRightTire);
        backLeftTire= new Tire("trasero izquierdo");
        tires.add(backLeftTire);
        backRightTire = new Tire("trasero derecho");
